...
void RenderSystem::initializeGlGeometryBuffers()
{
	...
	square_vertices[0] = {{ -1.f/2, +1.f/2, 0.f }, red};  // Top-left
	square_vertices[1] = {{ +1.f/2, +1.f/2, 0.f }, red};  // Top-right
	square_vertices[2] = {{ +1.f/2, -1.f/2, 0.f }, red};  // Bottom-right
	square_vertices[3] = {{ -1.f/2, -1.f/2, 0.f }, red};  // Bottom-left

	const std::vector<uint16_t> square_indices = { 0, 3, 1, 1, 3, 2 };
